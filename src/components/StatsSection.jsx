                ...
                {[
                  ...
                  <div key={index} className="col-md-4">
                    <div className="achievement-item">
                      <img src={item.img} alt="Achievement" className="img-fluid" />
